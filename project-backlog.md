...
| # | Task | Service | Status | Source |
|---|------|---------|--------|--------|
| 9.1 | CV/CL templates (modern, classic, minimal) + selector | workers, web | [ ] | PRD §11 P3.4, TRD FR-DG-03 |
...
| # | Task | Service | Status | Source |
|---|------|---------|--------|--------|
| 10.1 | Workday + Ashby ATS submitters (still HG-4) | workers | [ ] | TRD FR-AA-01, PRD §11 P4.2 |
| 10.2 | LinkedIn Easy Apply, Indeed, generic career portals | workers | [ ] | TRD FR-AA-02, AppFlow §2.3 |
| 10.3 | Per-site rate limits, daily caps, emergency stop | api, workers | [ ] | TRD FR-AA-07, Impl Plan W16/W18 |
